...
contract MasterWombatV2 {
    ...
    returns (
        ...
        IERC20[] memory bonusTokenAddress,
    ...
    function updateEmissionRate(uint104 _womPerSec) external {
        massUpdatePools();
        womPerSec = _womPerSec;
    ...
    function updateEmissionPartition(uint16 _basePartition) external {
    ...
    function setVeWom(IVeWom _newVeWom) external {
