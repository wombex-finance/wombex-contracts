...
task("deploy-lens:bnb").setAction(async function (taskArguments: TaskArguments, hre) {
    ...
    await lens.setUsdStablePoolsForToken(['0x312Bc7eAAF93f1C60Dc5AfC115FcCDE161055fb0', '0x0520451B19AD0bb00eD35ef391086A692CFC74B2', '0x48f6A8a0158031BaF8ce3e45344518f1e69f2A14', '0x8ad47d7ab304272322513eE63665906b64a49dA2', '0x277E777F7687239B092c8845D4d2cd083a33C903'], '0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56').then(tx => tx.wait(3));
    await lens.setUsdStablePoolsForToken(['0x05f727876d7C123B9Bb41507251E2Afd81EAD09A'], '0xd17479997F34dd9156Deef8F95A52D81D265be9c').then(tx => tx.wait(3));
    await lens.setUsdStablePoolsForToken(['0x4dFa92842d05a790252A7f374323b9C86D7b7E12'], '0xFa4BA88Cf97e282c505BEa095297786c16070129').then(tx => tx.wait(3));
    ...
    await lens.setTokenSwapThroughBnb(['0xf307910A4c7bbc79691fD374889b36d8531B08e3'], true).then(tx => tx.wait(3));
